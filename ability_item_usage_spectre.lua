...
local Consider ={}
local CanCast={logic.NCanCast,logic.NCanCast,logic.NCanCast,logic.NCanCast,logic.NCanCast}
...
Consider[4]=function()
	...
	if AbilitiesReal[4]:GetCooldown()-AbilitiesReal[4]:GetCooldownTimeRemaining()>5 or AbilitiesReal[4]:GetCooldown()-AbilitiesReal[4]:GetCooldownTimeRemaining()==0
	then
		return BOT_ACTION_DESIRE_NONE, 0;
	end

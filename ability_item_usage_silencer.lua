...
function Consider1()
	...
	then
		...
		do
			...
			then
				...
				then
					return BOT_ACTION_DESIRE_MODERATE,logic.GetUnitsTowardsLocation(npcEnemy,npcBot,Radius/2);
				end
			end
		end
	end
	...
	then
		...
		then
			...
			then
				return BOT_ACTION_DESIRE_MODERATE-0.03, logic.GetUnitsTowardsLocation(npcEnemy,npcBot,Radius/2);
			end
		end
	end
	...
	then
		...
		then
			...
			then
				...
				then
					return BOT_ACTION_DESIRE_LOW,logic.GetUnitsTowardsLocation(WeakestEnemy,npcBot,Radius/2);
				end
			end
		end
	end

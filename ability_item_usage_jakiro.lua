		...
		then
			...
			then
				...
				then
					...
					then
						return BOT_ACTION_DESIRE_HIGH,logic.GetUnitsTowardsLocation(npcBot,WeakestEnemy,200); 
					else
						return BOT_ACTION_DESIRE_HIGH,logic.GetUnitsTowardsLocation(npcBot,WeakestEnemy,GetUnitToUnitDistance(npcBot,WeakestEnemy)+200); 
					end
				end
			end
		end
